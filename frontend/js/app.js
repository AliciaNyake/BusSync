...
function buildStepper(containerId, booking, currentStep) {
  ...
  var html = '';
  if (currentStep === 2) html += '<button class="btn-back" onclick="window.location.href=\'../index.html\'" title="Retour">' + backSVG + '</button>';
  if (currentStep === 3) html += '<button class="btn-back" onclick="window.location.href=\'passagers.html\'" title="Retour">' + backSVG + '</button>';
